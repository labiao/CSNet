...
def resnet50(pretrained=True, **kwargs):
    ...
    if pretrained:
        ...
        # checkpoint = torch.load('/mnt/sdb1/zhengdaoyuan/PycharmProjects/CS-WSCDNet/pth/rsp-resnet-50-ckpt.pth')
        # state_dict = model_zoo.load_url(model_urls['resnet50'])
        # state_dict['conv1.weight'] = state_dict['conv1.weight'][:,:3,:,:]
        ...
        # loaded_keys = set(checkpoint['model'].keys())
        ...
        # 打印信息
        # print("匹配的键:", matched_keys)
        # print("缺失的键（模型中有，但未在加载的状态字典中找到）:", missing_keys)
        # print("多余的键（状态字典中有，但模型中没有）:", unexpected_keys)
